...
const ChangePassword = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(!currentPassword.length || !newPassword.length){
            return toast.error("Cannot submit empty password");
        }
        ...
        .then(() => {
            ...
            return toast.success("Password Updates sucessfully");
        })
        .catch(({response}) => {
            toast.dismiss(loadingToast);
            e.target.removeAttribute("disabled");
        ...
        <AnimationWrapper>
            ...
            <form ref={changePasswordForm}>
                ...
                <div className="py-10 w-full md:max-w-[400px]">
                    ...
                    <button onClick={handleSubmit} className="btn-dark px-10 mt-5" type="submit">Change Password</button>
                </div>
