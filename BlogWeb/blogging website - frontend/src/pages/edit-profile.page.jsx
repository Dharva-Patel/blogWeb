                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            ...
                            <button className="btn-light mt-5 max-lg:w-full px-10 center" onClick={handleImageUpload}>
                                Upload
                            </button>
                        ...
                        <div className="w-full">
                            ...
                            <p className="text-dark-grey -mt-3">Username used for searching and visible for all users</p>
